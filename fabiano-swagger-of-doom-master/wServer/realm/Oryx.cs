    ...
    internal class Oryx : IDisposable
    {
            ...
            spawn = new Dictionary<WmapTerrain, Tuple<int, Tuple<string, double>[]>>
            {
                ...
                },
                {
                    WmapTerrain.ShorePlains, Tuple.Create(
                        160, new[]
                        {
                            ...
                            Tuple.Create("Purple Gelatinous Cube", 0.16),
                            Tuple.Create("Green Gelatinous Cube", 0.17)
                        })
                },
                {
                ...
                },
                {
                    WmapTerrain.LowForest, Tuple.Create(
                        160, new[]
                        {
                            Tuple.Create("Elf Wizard", 0.3),
                            Tuple.Create("Goblin Mage", 0.4),
                ...
                },
                {
                    WmapTerrain.LowSand, Tuple.Create(
                        160, new[]
                        {
                            ...
                            Tuple.Create("Giant Crab", 0.3),
                            Tuple.Create("Sand Devil", 0.3)
                        })
                },
                {
                    WmapTerrain.MidPlains, Tuple.Create(
                        160, new[]
                        {
                            ...
                            Tuple.Create("Swarm", 0.13),
                            Tuple.Create("Wasp Queen", 0.2),
                            Tuple.Create("Shambling Sludge", 0.23),
                            Tuple.Create("Orc King", 0.16)
                        })
                },
                {
        ...
        public bool CheckFinalQuests()
        {
            if (CountEnemies(
                ...
                "Skull Shrine", "Cube God", "Ghost Ship", "Spectral Sentry", "Chubby Cow", "Pentaract Tower", "Hermit God", "Grand Sphinx", "Lord of the Lost Lands") != 0) return false;
            RealmClosed = true;
            return true;
        }
        ...
        public void InitCloseRealm()
        {
            ...
            world.Manager.GetWorld(World.NEXUS_ID).Timers.Add(new WorldTimer(70000, (w, t) => Task.Factory.StartNew(() => GameWorld.AutoName(1, true)).ContinueWith(_ => w.Manager.AddWorld(_.Result), TaskScheduler.Default)));
        ...
        private void EnsurePopulation()
        {
            ...
            {
                if (enemyCounts[i] > enemyMaxCounts[i] * 1.35)  //Kill some
                {
                    state[i] = 1;
...
#region "Taunt data"
        ...
        private static readonly Tuple<string, TauntData>[] criticalEnemies =
        {
            ...
            Tuple.Create("Chubby Cow", new TauntData
            {
                spawn = new[]
                {
                    "A big Chubby Cow has appeared in the realm!"
                },
                numberOfEnemies = new[]
                {
                    "You will be mush after this herd of cows stampedes you!"
                },
                final = new[]
                {
                    "This Chubby Cow is no serious business!"
                },
                killed = new[]
                {
            ...
            Tuple.Create("Spectral Sentry", new TauntData
            {
                spawn = new[]
                {
                    "This Spectral Sentry will never let you into the lost halls!"
                },
                numberOfEnemies = new[]
                {
                    "It makes sense that you would be afraid to face death itself!"
                },
                final = new[]
                {
                    "It makes sense that you would be afraid to face death itself!"
                ...
                killed = new[]
                {
                    "Even if you have gained access to the halls, the colossus will put a end to you!"
                }
            }),
            Tuple.Create("shtrs Defense System", new TauntData
            {
                spawn = new[]
                {
                    "This Avatar of the Forgotten King will never be broken by you!"
                },
                numberOfEnemies = new[]
                {
                    "Despite what you do, the shatters still remains!"
                },
                final = new[]
                {
                    "Despite what you do, the shatters still remains!"
                ...
                killed = new[]
                {
                    "What!? You were never as powerful as the King's Avatar..."
                }
            }),
            Tuple.Create("Hermit God", new TauntData
            {
                ...
                numberOfEnemies = new[]
                {
                    "This Hermit God has sunk thousands of battleships and soon it will sink you!"
                },
                final = new[]
                {
                    "This Hermit God has sunk thousands of battleships and soon it will sink you!"
