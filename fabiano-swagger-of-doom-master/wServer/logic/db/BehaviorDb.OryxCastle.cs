    ...
    partial class BehaviorDb
    {
        private _ OryxCastle = () => Behav()
            .Init("Oryx Stone Guardian Right",
                ...
                new ItemLoot("Titan's Breastplate", 0.001),
                new ItemLoot("Knight's Warhammer", 0.005),
                new ItemLoot("Helm of Duality", 0.005),
                new ItemLoot("Legendary Stone Sword", 0.005),
                new ItemLoot("Gargoyle Crusher", 0.006),
                new ItemLoot("Cloak of Terradius", 0.006),
                new ItemLoot("Faithless Execution", 0.007),
                new ItemLoot("Ruby Plated Armor", 0.007),
                new ItemLoot("Gauntlet of Mortality", 0.007),
                new ItemLoot("Ancient Stone Sword", 0.04),
                new ItemLoot("Ivory Ring", 0.04),
            ...
            .Init("Oryx Stone Guardian Left",
                new State(
                    ...
                    new State("Start",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Flash(0xC0C0C0, 0.5, 10),
                        new TimedTransition(5000, "Together is better")
                    ),
                    new State("Together is better",
        	...
        	.Init("Oryx Suit of Armor",
        	    new State(
        	      	new State("idle",
        	      	    new PlayerWithinTransition(5, "jordan is stanking"),
                        new HpLessTransition(0.99, "jordan is stanking")
                          ),
