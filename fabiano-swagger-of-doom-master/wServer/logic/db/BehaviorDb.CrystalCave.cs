    ...
    partial class BehaviorDb
    {
        private _ CrystalCave = () => Behav()
            ...
            .Init("Crystal Prisoner",
                ...
                new ItemLoot("Potion of Attack", 0.88),
                new ItemLoot("Potion of Defense", 0.88),
                new ItemLoot("Potion of Speed", 0.88),
                new ItemLoot("Potion of Dexterity", 0.88),
            ...
            .Init("Crystal Prisoner Steed",
                new State(
                    ...
                    new State("attack",
                        new Shoot(10, count: 3, shootAngle: 12, predictive: 0.3, coolDown: 800),
