    ...
    partial class BehaviorDb
    {
        private _ Lich = () => Behav()
            .Init("Lich",
                new State(
                    ...
                    new State("HugeMob",
                        ...
                        new HpLessTransition(0.7, "HugeMob2"),
                        new TimedTransition(5000, "HugeMob2")
                        ),
                    new State("HugeMob2",
                    ...
                    new State("Mob",
                        ...
                        new HpLessTransition(0.7, "Mob2"),
                        new TimedTransition(5000, "Mob2")
                        ),
                    new State("Mob2",
                        new Taunt("My minions have stolen your life force and fed it to me!"),
                        new Spawn("Haunted Spirit", 2, 0, 2000),
                    ...
                    new State("SmallGroup",
                        ...
                        new HpLessTransition(0.7, "SmallGroup2"),
                        new TimedTransition(5000, "SmallGroup2")
                        ),
            ...
            .Init("Actual Lich",
                ...
                new ItemLoot("Potion of Defense", 0.40),
                new ItemLoot("Potion of Speed", 0.50),
                new ItemLoot("Health Potion", 0.50),
            ...
            .Init("Phylactery Bearer",
                ...
                new Threshold(0.001,
                new ItemLoot("Necklace of Undead Support", 0.007),
                new ItemLoot("The Phylactery", 0.04),
                new ItemLoot("Soul of the Bearer", 0.04),
                new ItemLoot("Soulless Robe", 0.04),
                new ItemLoot("Ring of the Covetous Heart", 0.04),
                new ItemLoot("Potion of Wisdom", 0.15),
                new ItemLoot("Potion of Mana", 0.015)
                )
            )
            .Init("Haunted Spirit",
                new State(
