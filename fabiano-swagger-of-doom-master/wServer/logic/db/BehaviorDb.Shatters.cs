    ...
    partial class BehaviorDb
    {
        ...
        #region generators
            ...
            new State(
                new State("Main",
                    new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    new Shoot(15, 10, coolDown: 700),
                    new Shoot(15, 1, projectileIndex: 1, coolDown: 3400),
        ...
        #region portals
            ...
            new State(
                ...
                new State(
                    ...
                    new Charge(0.1, 6, coolDown: 7000),
                new Shoot(13, 7, 16, projectileIndex: 0, coolDown: 2000)
                ),
            new State("Death",
        ...
        #region 1stboss
            .Init("shtrs Bridge Sentinel",
                new State(
                    ...
                    new HpLessTransition(0.14, "Death"),
                    new State("Idle",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    ...
                    new State("BEGIN",
                        ...
                        new Timed(2100, new Shoot(19, 19, 12, projectileIndex: 0, fixedAngle: 180, coolDown: 1000, coolDownOffset: 1000)),
                        new TimedTransition(8000, "Swirl Shot")
                        ),
                        new State("Swirl Shot",
                            new Taunt("Go."),
                            new State("Swirl1",
                            new Shoot(19, 19, 11, projectileIndex: 0, fixedAngle: 180, coolDown: 2000, coolDownOffset: 500),
                            ...
                            new HpLessTransition(0.62, "Blobomb")
                            )
                            ),
                            new State("Blobomb",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            ...
                            new Taunt("CONSUME!"),
                            new Spawn("shtrs Blobomb", maxChildren: 4, initialSpawn: 2, coolDown: 1000),
                            new TimedTransition(1300, "SwirlAndShoot")
                                ),
                                new State("SwirlAndShoot",
                                    new TimedTransition(12000, "Blobomb"),
                                    new Taunt("FOOLS! YOU DO NOT UNDERSTAND!"),
                                    new ChangeSize(20, 130),
                            new Shoot(19, 19, 11, projectileIndex: 0, fixedAngle: 177, coolDown: 2000, coolDownOffset: 500),
                            new Shoot(19, 19, 11, projectileIndex: 0, fixedAngle: 183, coolDown: 2200, coolDownOffset: 1500),
                                    new State("Swirl1_2",
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 102, fixedAngle: 102, coolDown: 6000),
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 114, fixedAngle: 114, coolDown: 6000, coolDownOffset: 200),
                            new Shoot(50, projectileIndex: 0, count: 1, shootAngle: 126, fixedAngle: 126, coolDown: 6000, coolDownOffset: 400),
            ...
            .Init("shtrs Twilight Archmage",
                new State(
                    ...
                    new State("TossShit",
                        ...
                        new TossObject("shtrs FireBomb", 2, coolDown: 25000, randomToss: true),
                        new TossObject("shtrs FireBomb", 3, coolDown: 25000, randomToss: true),
                        ...
                        new TossObject("shtrs FireBomb", 6, coolDown: 25000, randomToss: true),
                        new TossObject("shtrs FireBomb", 7, coolDown: 25000, randomToss: true),        //NOT IN USE!
                        ...
                        new TimedTransition(1, "Active2")
                        ),
                  new State("Shoot",
                    new Shoot(15, 5, 5, projectileIndex: 1, coolDown: 200),
                    new Shoot(25, 12, 30, projectileIndex: 1, coolDown: 400),
                    new TimedTransition(800, "Shoot"),
                    new HpLessTransition(0.55, "Pre Birds")
                        ),
                    new State("Pre Birds",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                    ...
                    new State("Birds",
                        ...
                        new TossObject("shtrs Ice Portal", 10, coolDown: 12000, coolDownOffset: 4000),
                        new TossObject("shtrs Fire Portal", 10, coolDown: 12000, coolDownOffset: 10000),
                        new EntitiesNotExistsTransition(500, "PreNewShit2", "shtrs Inferno", "shtrs Blizzard")
                        ),
                    new State("PreNewShit2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Taunt("My birds are gone! You will never recover from this!"),
                        new TimedTransition(3000, "NewShit2")
                        ),
                    new State("NewShit2",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(0, -6, 1),
                        new TimedTransition(3000, "TossShit")
                        ),
                    new State("Active2",
                        ...
                        new TimedTransition(3000, "NewShit3")
                        ),
                    new State("NewShit3",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(4, 0, 1),
                    ...
                    new State("Active3",
                        ...
                        new Shoot(15, 20, projectileIndex: 5, coolDown: 100000000, coolDownOffset: 500),
                        new Shoot(15, 20, projectileIndex: 6, coolDown: 100000000, coolDownOffset: 600),
                        new TossObject("shtrs FireBomb", 1, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 2, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 3, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 4, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 5, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 6, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 7, coolDown: 25000, coolDownOffset: 2900, randomToss: true),        //NOT IN USE!
                        new TossObject("shtrs FireBomb", 8, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 9, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 10, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 11, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 12, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 13, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TimedTransition(3000, "NewShit4")
                        ),
                    new State("NewShit4",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(0, 13, 1),
                    ...
                    new State("Active4",
                        ...
                        new TossObject("shtrs FireBomb", 12, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 13, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TimedTransition(3000, "NewShit5")
                        ),
                    new State("NewShit5",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(-4, 0, 1),
                    ...
                    new State("Active5",
                        ...
                        new TossObject("shtrs FireBomb", 12, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 13, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TimedTransition(3000, "NewShit6")
                        ),
                    new State("NewShit6",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(-4, 0, 1),
                    ...
                    new State("Active6",
                        ...
                        new TossObject("shtrs FireBomb", 12, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TossObject("shtrs FireBomb", 13, coolDown: 25000, coolDownOffset: 2900, randomToss: true),
                        new TimedTransition(3000, "NewShit7")
                        ),
                    new State("NewShit7",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new MoveTo(0, -13, 1),
            ...
            .Init("shtrs Inferno",
                new State(
                    new Orbit(0.5, 4, 15, "shtrs Blizzard"),
                            new Shoot(0, projectileIndex: 0, count: 5, shootAngle: 25, coolDown: 2000),
                            new Shoot(0, projectileIndex: 0, count: 6, shootAngle: 60, fixedAngle: 15, coolDown: 1200),
                            new Shoot(0, projectileIndex: 0, count: 6, shootAngle: 60, fixedAngle: 30, coolDown: 1800),
                            new Shoot(0, projectileIndex: 0, count: 6, shootAngle: 60, fixedAngle: 60, coolDown: 3600),
            ...
            .Init("shtrs Blizzard",
                new State(
                    ...
                    new Follow(0.3, range: 1, coolDown: 1000),
                            new Shoot(0, projectileIndex: 0, count: 4, shootAngle: 90, fixedAngle: 45, coolDown: 500),
        ...
        #region 1stbosschest
            .Init("shtrs Loot Balloon Bridge",
                ...
                new ItemLoot("Blades of the Bridge", 0.0042),
                new ItemLoot("Bel's Decapitator", 0.0042),
                new ItemLoot("Bracer of the Guardian", 0.04),
                new ItemLoot("The Forgotten Ring", 0.04),
                new ItemLoot("Backpack", 0.08),
                new ItemLoot("Path of Loot Key", 0.0008),
                ...
                new TierLoot(11, ItemType.Weapon, 0.13),
                new TierLoot(12, ItemType.Weapon, 0.13),
                new TierLoot(5, ItemType.Ability, 0.15),
                new TierLoot(6, ItemType.Ability, 0.15),
                new TierLoot(12, ItemType.Armor, 0.11),
                new TierLoot(13, ItemType.Armor, 0.11),
        ...
        #region 2ndbosschest
            .Init("shtrs Loot Balloon Mage",
                ...
                new ItemLoot("Greatcloak of Twilight", 0.0042),
                new ItemLoot("Wand of Bone", 0.0042),
                new ItemLoot("Malevolent Armor", 0.0042),
                new ItemLoot("Magic-Infused Dice", 0.0042),
                ...
                new ItemLoot("Backpack", 0.08),
                new ItemLoot("Path of Loot Key", 0.0009),
                new ItemLoot("Transformation Shard", 0.001),
        ...
        #region BridgeStatues
            ...
            .Init("shtrs Bridge Obelisk C",                                                     //YELLOW TOWERS!
                new State(
                    ...
                    new State("Pause",
                        new Spawn("shtrs Stone Paladin", maxChildren: 1, initialSpawn: 1, coolDown: 5000),
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new TimedTransition(7000, "Shoot")
                        )
                    )
        ...
        #region SomeMobs
            ...
            .Init("shtrs Ice Mage",
                new State(
                    new State("Wait",
                        new PlayerWithinTransition(7, "fire")
                            ),
                    new State("fire",
        ...
        #region WOODENGATESSWITCHESBRIDGES
            ...
            .Init("shtrs Wooden Gate",
                new State(
                    new State("Idle",
                        new EntityNotExistsTransition("shtrs Abandoned Switch 1", 100, "Despawn") //was 10
                        ),
                    new State("Despawn",
                        new Decay(0)
                        )
            ...
            .Init("shtrs Wooden Gate 2",
                new State(
                    new State("Idle",
                        new EntityNotExistsTransition("shtrs Abandoned Switch 2", 300, "Despawn") //was 60
                        ),
                    new State("Despawn",
                        new Decay(0)
                        )
        ...
        #region 3rdboss
                ...
                new State(
                    ...
                    new State("red",
                        ...
                        new State("Swirl1",
                            ...
                            new HpLessTransition(0.66, "middle"),
                        ...
                        new State("Swirl7",
                            ...
                            new Shoot(15, 1, projectileIndex: 1, fixedAngle: 70, coolDown: 100),
                            new Shoot(15, 1, projectileIndex: 1, fixedAngle: 105, coolDown: 100),
                            new Shoot(15, 1, projectileIndex: 1, fixedAngle: 10, coolDown: 100),
                        ...
                        new State("littlerage",
                            ...
                            new Shoot(10, 1, projectileIndex: 2, coolDown: 100),
                            new Shoot(10, 1, projectileIndex: 3, coolDown: 100),
                            new Spawn("shtrs Archmage of Flame", maxChildren: 2, initialSpawn: 1, coolDown: 4000),
                            new TimedTransition(1000, "Raged1")
                            ),
                        new State("Raged1",
                            new Taunt("TENTACLES OF WRATH"),
                            new ConditionalEffect(ConditionEffectIndex.Armored),
                            new Spawn("shtrs Ice Mage", maxChildren: 2, initialSpawn: 1, coolDown: 4000),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 3, coolDown: 10800),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 5, coolDown: 10800),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 8, coolDown: 10800, coolDownOffset: 200),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 1, coolDown: 10800, coolDownOffset: 200),
                            ...
                            new HpLessTransition(0.3, "MoveTo"),
                        ...
                        new State("God",
                            ...
                            new ConditionalEffect(ConditionEffectIndex.Armored),
                            new Spawn("shtrs Fire Mage", maxChildren: 2, initialSpawn: 1, coolDown: 4000),
                            new Shoot(15, 30, shootAngle: 12, projectileIndex: 1, fixedAngle: 87, coolDown: 1200),
                            new Shoot(15, 30, shootAngle: 12, projectileIndex: 1, fixedAngle: 93, coolDown: 1200, coolDownOffset: 600),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 3, coolDown: 10800),
                            ...
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 165, coolDown: 10800, coolDownOffset: 10800),
                            new Shoot(50, projectileIndex: 4, count: 6, shootAngle: 60, fixedAngle: 166, coolDown: 10800, coolDownOffset: 10800),
                            new TimedTransition(11000, "Hahaha")
                            ),
                        new State("Hahaha",
            ...
            .Init("shtrs Royal Guardian J",
                new State(
                    ...
                    new State("shoot",
                        ...
                        new Shoot(25, projectileIndex: 1, count: 7, shootAngle: 30, coolDown: 1500, coolDownOffset: 400)
                        )
                    )
            )
            ...
            .Init("shtrs Green Crystal",
                new State(
                    ...
                    new State("orbit",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
                        new TimedTransition(2000, "dafuq")
                        ),
                    new State("dafuq",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
                        new Grenade(4, 150, 10, coolDown: 800)
                        )
                    )
            )
            .Init("shtrs Yellow Crystal",
                new State(
                    ...
                    new State("dafuq",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
                        new Shoot(8, 5, 12, projectileIndex: 0, coolDown: 1500)
                        )
                    )
            )
            .Init("shtrs Red Crystal",
                new State(
                    ...
                    new State("dafuq",
                        new Orbit(1.0, 2, 5, "shtrs The Forgotten King"),
                        new TimedTransition(2000, "ThrowPortal")
                        ),
                    new State("ThrowPortal",
                        new TossObject("shtrs Fire Portal", 11, coolDown: 3500, randomToss: false),
            ...
            .Init("shtrs Blue Crystal",
                new State(
                    ...
                    new State("ThrowPortal",
                        new TossObject("shtrs Ice Portal", 14, coolDown: 3000, randomToss: false),
                        new TimedTransition(25, "orbit")
                        )
                    )
            )
