    ...
    partial class BehaviorDb
    {
        private _ EntAncient = () => Behav()
            ...
            .Init("Actual Ent Ancient",
                new State(
                    ...
                    new State("Growing9",
                        ...
                        new State("received_armor",
                            ...
                            new TimedTransition(1000, "unshielded")
                            ),
                        new State("shielded",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                ...
                new ItemLoot("Battleaxe of the Ent", 0.004),
            ...
            .Init("Ent",
                ...
                new Threshold(0.001,
                new ItemLoot("The Soul Ring", 0.005),
            ...
            .Init("Greater Nature Sprite",
                new State(
                    ...
                    new State("Idle"),
                    new TimedTransition(4500, "Transform"),
                    new State("Transform",
            ...
            .Init("Actual Greater Nature Sprite",
                ...
                new Threshold(0.001,
                new ItemLoot("Staff of Nature", 0.007),
                new ItemLoot("Quiver of Thunder", 0.04),
