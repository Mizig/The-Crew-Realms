    ...
    partial class BehaviorDb
    {
        private _ Avatar = () => Behav()
            .Init("shtrs Defense System",
                new State(
                    new DropPortalOnDeath("The Shatters", percent: 100, dropDelaySec: 2, XAdjustment: 0, YAdjustment: 2, PortalDespawnTimeSec: 70),
                    ...
                    new State("stars after niggo",
                        new Taunt("You show some strength, but your coniction is lacking."),
                        new Taunt("BURN!!"),
                    ...
                    new State("blobombs do boom!",
                        new State(
                            ...
                            new TossObject("shtrs blobomb", 5, 0, coolDown: 3500, coolDownOffset: 1900),
                            new TossObject("shtrs blobomb", 5, 45, coolDown: 3500, coolDownOffset: 1900),
                            new TossObject("shtrs blobomb", 5, 90, coolDown: 3500, coolDownOffset: 1900),
                            new TossObject("shtrs blobomb", 5, 135, coolDown: 3500, coolDownOffset: 1900),
                            new TossObject("shtrs blobomb", 5, 180, coolDown: 3500, coolDownOffset: 1900),
            ...
            .Init("shtrs Pillar 1",
                new State(
                    ...
                    new State("PROTECT",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(20, count: 10, projectileIndex: 0, coolDown: 1500),
                        new TimedTransition(5000, "preparing")
                        ),
                    new State("preparing",
                        new ConditionalEffect(ConditionEffectIndex.Armored),
            ...
            .Init("shtrs Pillar 4",
                new State(
                    ...
                    new State("PROTECT",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new Shoot(20, count: 10, projectileIndex: 0, coolDown: 1500),
                        new TimedTransition(20000, "preparing")
                        ),
                    new State("preparing",
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new Flash(0x0D00FF, 0.4, 10),
