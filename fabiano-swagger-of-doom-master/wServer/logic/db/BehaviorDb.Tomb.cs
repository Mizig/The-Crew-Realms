        ...
        private _ Tomb = () => Behav()
            .Init("Tomb Defender",                                         //Tomb Defender == Bes; His rage phase is perfectly working, needs no adjustments, but
                ...
                new State(
                    ...
                    new State("active",
                        new Orbit(.5, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
                ...
                new ItemLoot("Blessed Ring of the Tomb", 0.003),
                ...
                new ItemLoot("Potion of Life", 0.45),
                new ItemLoot("Potion of Defense", 0.45),
            ...
            .Init("Tomb Support",                                               //tomb support == Nut; I added my own rage phase, because Fabiano's didn't have
                ...
                new ItemLoot("Potion of Life", 1.0),
                new ItemLoot("Potion of Life", 0.45),
                new ItemLoot("Potion of Speed", 0.45),
                new TierLoot(9, ItemType.Weapon, 0.15),
                new TierLoot(10, ItemType.Weapon, 0.15),
                new TierLoot(11, ItemType.Weapon, 0.15),
                new TierLoot(4, ItemType.Ability, 0.17),
            ...
            .Init("Tomb Attacker",                                    //Tomb Attacker == Geb; I added my own rage phase, again, because Fabiano's didn't have anything from
                ...
                new State(
                    ...
                    new State("idle",
                        ...
                        new ConditionalEffect(ConditionEffectIndex.Armored),
                        new Orbit(0.7, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
                        new HpLessTransition(.99, "weakning")
                    ),
                    new State("weakning",
                        new Orbit(.5, 5, target: "Tomb Boss Anchor", radiusVariance: 0.5),
                ...
                new ItemLoot("Potion of Life", 1.0),
                new ItemLoot("Potion of Life", 0.45),
                new ItemLoot("Potion of Attack", 0.45),
                new TierLoot(9, ItemType.Weapon, 0.15),
                new TierLoot(10, ItemType.Weapon, 0.15),
                new TierLoot(11, ItemType.Weapon, 0.15),
                new TierLoot(4, ItemType.Ability, 0.17),
            ...
            .Init("Tomb Defender Statue",
                new State(
                    new State(
                        ...
                        new EntityNotExistsTransition("Nexus Crier", 1000, "checkActive"),
                        new EntityNotExistsTransition("Nexus Crier", 1000, "checkInactive")
                        ),
                    new State("checkActive",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                        new EntityNotExistsTransition("Nexus Crier", 1000, "ItsGoTime")
                        ),
