                ...
                new State(
                    ...
                    new State("Silver Blasts",
                        ...
                        new State("Silver Blasts 2",
                            ...
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blasts 3")
                        ),
                        new State("Silver Blasts 3",
                            ...
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blasts 4")
                        ),
                        new State("Silver Blasts 4",
                            ...
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blasts 5")
                        ),
                        new State("Silver Blasts 5",
                            ...
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blasts 6")
                        ),
                        new State("Silver Blasts 6",
                            ...
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blasts 7")
                        ),
                        new State("Silver Blasts 7",
                            ...
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blasts 8")
                        ),
                        new State("Silver Blasts 8",
                            ...
                            new Shoot(10, count: 1, angleOffset: 225, projectileIndex: 0),
                            new Shoot(10, count: 2, shootAngle: 10, angleOffset: 315, projectileIndex: 0),
                            new TimedTransition(800, "Spawn Stheno Swarm")
                        )
                    ),
                    new State("Spawn Stheno Swarm",
                        ...
                        new State("Silver Blast 1",
                            ...
                            new TimedTransition(800, "Silver Blast 2")
                        ),
                        new State("Silver Blast 2",
                            new Shoot(10, count: 1, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 3")
                        ),
                        new State("Silver Blast 3",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 4")
                        ),
                        new State("Silver Blast 4",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 5")
                        ),
                        new State("Silver Blast 5",
                            new Shoot(10, count: 1, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 6")
                        ),
                        new State("Silver Blast 6",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 7")
                        ),
                        new State("Silver Blast 7",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 8")
                        ),
                        new State("Silver Blast 8",
                            new Shoot(10, count: 1, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 9")
                        ),
                        new State("Silver Blast 9",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 10")
                        ),
                        new State("Silver Blast 10",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 11")
                        ),
                        new State("Silver Blast 11",
                            new Shoot(10, count: 1, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 12")
                        ),
                        new State("Silver Blast 12",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 13")
                        ),
                        new State("Silver Blast 13",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 14")
                        ),
                        new State("Silver Blast 14",
                            new Shoot(10, count: 1, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 15")
                        ),
                        new State("Silver Blast 15",
                            ...
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Silver Blast 16")
                        ),
                        new State("Silver Blast 16",
                            new Shoot(10, count: 1, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 270, projectileIndex: 0),
                            new Shoot(10, count: 1, angleOffset: 90, projectileIndex: 0),
                            new TimedTransition(800, "Leave me")
                        ),
                        new State("Leave me",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new Order(100, "Stheno Swarm", "Despawn"),
                            new TimedTransition(800, "Blind Ring Attack + ThrowAttack")
                        )
                    ),
                    new State("Blind Ring Attack + ThrowAttack",
                        ...
                        new State("Blind Ring Attack + ThrowAttack 1",
                            ...
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 2")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 2",
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 3")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 3",
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 4")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 4",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable, true),
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 5")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 5",
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 6")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 6",
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 7")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 7",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable),
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 8")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 8",
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 9")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 9",
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 10")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 10",
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 11")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 11",
                            new ConditionalEffect(ConditionEffectIndex.Invulnerable, true),
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Blind Ring Attack + ThrowAttack 12")
                        ),
                        new State("Blind Ring Attack + ThrowAttack 12",
                            new Shoot(10, count: 6, projectileIndex: 1),
                            new Grenade(2.5, 100, 10),
                            new TimedTransition(400, "Silver Blasts")
                        )
                    )
                ),
                new Threshold(0.001,
