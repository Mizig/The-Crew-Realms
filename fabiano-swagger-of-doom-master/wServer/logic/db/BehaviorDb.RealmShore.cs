...
namespace wServer.logic
{
    ...
    {
        private _ RealmShore = () => Behav()
            .Init("Pirate",
                new State(
                    new DropPortalOnDeath("Pirate Cave Portal", 10, PortalDespawnTimeSec: 100),
                    new Prioritize(
                ...
                new TierLoot(1, ItemType.Armor, 0.12),
            ...
            .Init("Snake",
                ...
                new Threshold(0.001,
                new ItemLoot("Grape Jello", 0.0000001),
                new ItemLoot("The Crusher", 0.0000001)
                ),
                new TierLoot(1, ItemType.Weapon, 0.15),
                new TierLoot(1, ItemType.Ability, 0.17),
                new TierLoot(1, ItemType.Armor, 0.12),
