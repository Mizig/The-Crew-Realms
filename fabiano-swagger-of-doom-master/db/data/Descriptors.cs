...
public class Item : IFeedable
{
    ...
    public Item(ushort type, XElement elem)
    {
        try
        {
            ...
            DomLGTier = elem.Element("DomLGTier") != null;
            ValorLGTier = elem.Element("ValorLGTier") != null;
            RotFLGTier = elem.Element("RotFLGTier") != null;
            DemonicTier = elem.Element("DemonicTier") != null;
            PrimalTier = elem.Element("PrimalTier") != null;
            ARTier = elem.Element("ARTier") != null;
            LightTier = elem.Element("LightTier") != null;
            CosmicTier = elem.Element("CosmicTier") != null;
    ...
    public bool DomLGTier { get; private set; }
    public bool DemonicTier { get; private set; }
    public bool PrimalTier { get; private set; }
    public bool CosmicTier { get; private set; }
    ...
    public bool ARTier { get; private set; }
    public bool LightTier { get; private set; }
    public bool ValorLGTier { get; private set; }
    public bool RotFLGTier { get; private set; }
}
