...
public class ObjectLibrary {
    ...
    public static function getRedrawnTextureFromType(_arg1:int, _arg2:int, _arg3:Boolean, _arg4:Boolean = true, _arg5:Number = 5) : BitmapData
    {
        ...
        if(_local8 == null && _local9.hasOwnProperty("DoMLGTier"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,16764231,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("ValorLGTier"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,16776960,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("RotFLGTier"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,16718205,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("IcaSRTier"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,53895,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("DemonicTier"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,10361131,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("PrimalTier"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,14745606,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("ARTier"))
        {
            return TextureRedrawer.redraw(_local6,_arg2,_arg3,13398094,_arg4,_arg5);
        }
        if(_local8 == null && _local9.hasOwnProperty("LightTier"))
        {
