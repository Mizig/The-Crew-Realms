...
public class Options extends Sprite {
    ...
    private static const TABS:Vector.<String> = new <String>[TextKey.OPTIONS_CONTROLS, TextKey.OPTIONS_HOTKEYS, TextKey.OPTIONS_CHAT, TextKey.OPTIONS_GRAPHICS, TextKey.OPTIONS_SOUND, TextKey.OPTIONS_EXPERIMENTAL];
    ...
    private function setSelected(_arg_1:OptionsTabTitle):void {
        ...
        switch (this.selected_.text_) {
            ...
            //case TextKey.OPTIONS_MISC:
                //this.addMiscOptions();
                //return;
            case TextKey.OPTIONS_EXPERIMENTAL:
                this.addExperimentalOptions(); //addFriendOptions
                return;
            //case "Experimental":
