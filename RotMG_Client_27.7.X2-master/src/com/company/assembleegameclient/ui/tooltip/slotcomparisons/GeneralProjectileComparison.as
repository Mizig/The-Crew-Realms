...
public class GeneralProjectileComparison extends SlotComparison {
    ...
    private function buildRateOfFireText():void {
        ...
        var _local_1:Number = Number(this.itemXML.RateOfFire[0]);
        var _local_2:Number = Number(this.curItemXML.RateOfFire[0]);
        comparisonStringBuilder.pushParams(TextKey.RATE_OF_FIRE, {"data": wrapInColoredFont(((_local_1 * 100) + "%"), getTextColor((_local_1 - _local_2)))});
