...
public class EquipmentToolTip extends ToolTip {
    ...
    private function addTierText():void {
        ...
        if (((((_local_1) && (_local_2))) && (_local_3))) {
            ...
            else if (this.objectXML.hasOwnProperty("DoMLGTier")) {
                this.tierText.setColor(0xFFCD47);
                this.tierText.setStringBuilder(new LineBuilder().setParams(TextKey.DOMLGTIER));
            }
            else if (this.objectXML.hasOwnProperty("ValorLGTier")) {
                this.tierText.setColor(0xFFFF00);
                this.tierText.setStringBuilder(new LineBuilder().setParams(TextKey.VALORLGTIER));
            }
            else if (this.objectXML.hasOwnProperty("RotFLGTier")) {
                this.tierText.setColor(0xFF197D);
                this.tierText.setStringBuilder(new LineBuilder().setParams(TextKey.ROTFLGTIER));
            }
            else if (this.objectXML.hasOwnProperty("IcaSRTier")) {
                this.tierText.setColor(0x00D287);
                this.tierText.setStringBuilder(new LineBuilder().setParams(TextKey.ICASRTIER));
            }
            else if (this.objectXML.hasOwnProperty("DemonicTier")) {
                this.tierText.setColor(0x9E192B);
                this.tierText.setStringBuilder(new LineBuilder().setParams(TextKey.DEMONICTIER));
            }
            else if (this.objectXML.hasOwnProperty("PrimalTier")) {
                this.tierText.setColor(0xE10006);
                this.tierText.setStringBuilder(new LineBuilder().setParams(TextKey.PRIMALTIER));
            }
            else if (this.objectXML.hasOwnProperty("ARTier")) {
                this.tierText.setColor(0xCC704E);
                this.tierText.setStringBuilder(new LineBuilder().setParams(TextKey.ARTIER));
            }
            else if (this.objectXML.hasOwnProperty("LightTier")) {
    ...
    private function makeRestrictionList():void {
        ...
        if (this.objectXML.hasOwnProperty("DoMLGTier")) {
            this.restrictions.push(new Restriction(("Very Magical Legendary."), 0xFFCD47, false));
        }
        if (this.objectXML.hasOwnProperty("ValorLGTier")) {
            this.restrictions.push(new Restriction(("Has Legendary Valor."), 0xFFFF00, false));
        }
        if (this.objectXML.hasOwnProperty("RotFLGTier")) {
            this.restrictions.push(new Restriction(("A Fallen Legendary."), 0xFF197D, false));
        }
        if (this.objectXML.hasOwnProperty("IcaSRTier")) {
            this.restrictions.push(new Restriction(("A Super Rare item."), 0x00D287, false));
        }
        if (this.objectXML.hasOwnProperty("DemonicTier")) {
            this.restrictions.push(new Restriction(("Consumed with Demonic energy."), 0x9E192B, false));
        }
        if (this.objectXML.hasOwnProperty("PrimalTier")) {
            this.restrictions.push(new Restriction(("A powerful Primal item."), 0xE10006, false));
        }
        if (this.objectXML.hasOwnProperty("ARTier")) {
            this.restrictions.push(new Restriction(("One of the Ancient Relics."), 0xCC704E, false));
        }
