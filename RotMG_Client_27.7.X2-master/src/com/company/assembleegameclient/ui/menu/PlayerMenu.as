...
public class PlayerMenu extends Menu {
    ...
    public function initDifferentServer(_arg_1:AGameSprite, _arg_2:String, _arg_3:Boolean = false, _arg_4:Boolean = false):void {
        ...
        addOption(_local_5);
        _local_5 = new MenuOption(AssetLibrary.getImageFromSet("lotfInterfaceBig", 10), 0xFFFFFF, TextKey.FRIEND_ADD_TITLE);
        _local_5.addEventListener(MouseEvent.CLICK, this.onAddFriend);
        addOption(_local_5);
        if (_arg_3) {
            _local_5 = new MenuOption(AssetLibrary.getImageFromSet("lofiInterfaceBig", 21), 0xFFFFFF, TextKey.PLAYERMENU_GUILDCHAT);
            _local_5.addEventListener(MouseEvent.CLICK, this.onGuildMessage);
            addOption(_local_5);
        }
        if (_arg_4) {
            _local_5 = new MenuOption(AssetLibrary.getImageFromSet("lofiInterfaceBig", 7), 0xFFFFFF, TextKey.PLAYERMENU_TRADE);
    ...
    public function init(_arg_1:AGameSprite, _arg_2:Player):void {
        ...
        _local_3 = new MenuOption(AssetLibrary.getImageFromSet("lofiInterfaceBig", 18), 0xFFFFFF, "Add as Friend");
